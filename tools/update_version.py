...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright ANovitskiy, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Oscillator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Oscillator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Oscillator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Oscillator-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Oscillator-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Oscillator-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Oscillator-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Oscillator.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Oscillator.iss",inplace=1):
